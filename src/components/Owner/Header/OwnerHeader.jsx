...
import { drawerWidth } from "../../Admin/Sidebar/Sidebar";
...
function OwnerHeader({ isOpen, onToggleSidebar }) {
    ...
    const checkLogin = () => {
        axios
            .get("http://127.0.0.1:8000/api/chu-san/kiem-tra-dang-nhap", {
                headers: {
    ...
    const logOut = () => {
        axios
            .post(
                "http://127.0.0.1:8000/api/chu-san/dang-xuat",
                {},
                {
                    headers: {
                        Authorization: "Bearer " + localStorage.getItem("token_chu_san"),
            ...
            .then((res) => {
                ...
                if (res.data.status) {
                    ...
                    localStorage.removeItem("token_chu_san");
                ...
                >
                    ...
                    <Box>
                        ...
                        >
                            ...
                            <Typography variant="body1" sx={STYLE_TYPO}>
                                {isLoggedIn ? ownerName : "Tài khoản"}
